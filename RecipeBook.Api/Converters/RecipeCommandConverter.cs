...
namespace RecipeBook.Api.Converters
{
    public static class RecipeCommandConverter
    {
        ...
        public static EditRecipeCommand ConvertToEditRecipeCommand( this EditRecipeCommandDto recipe, FormFileAdapter fileAdapter )
        {
            return new EditRecipeCommand( recipe.Title,
                recipe.Description,
                recipe.CookingTimeInMinutes,
                recipe.PortionsCount,
                recipe.Tags,
